...
public class pa3 {
	public static void main(String[]args) throws NoSuchAlgorithmException, IOException
	{
		 ...
		 * K is the secret key 
		 * K' is the block sized key derived from the secret key K
		 * || concatenation 
		 * 
		 * If the key is longer than 512 bits (64 bytes) we shorten by hashing 
		 * If the key is shorter than 512 bits we pad with 0s
		 */
		...
		byte[] ipadn = new byte[64];
		byte[] opadn = new byte[64];
